...
export function nodeCredentialEntityReducer(
  ...
  switch (action.type) {
    ...
    case NodeCredentialActionTypes.GET_ALL_SUCCESS: {
      ...
      ) as NodeCredentialEntityState;
    }

    case NodeCredentialActionTypes.GET_ALL_FAILURE: {
      return set(GET_ALL_STATUS, EntityStatus.loadingFailure, state) as NodeCredentialEntityState;
    }

    case NodeCredentialActionTypes.CREATE: {
      return set(SAVE_STATUS, EntityStatus.loading, state) as NodeCredentialEntityState;
    }
