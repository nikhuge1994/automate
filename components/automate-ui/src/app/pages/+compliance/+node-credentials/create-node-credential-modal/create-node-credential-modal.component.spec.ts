...
import { SaveNodeCredential, NodeCredential } from 'app/entities/node-credentials/node-credential.model';
...
describe('CreateNodeCredentialModalComponent', () => {
  ...
  it('opening create modal resets id, name, type, last_modified,tags and data to empty string',
    () => {
